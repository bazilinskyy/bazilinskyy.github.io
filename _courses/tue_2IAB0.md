...
<img alt="Data analytics pipeline: problem statement, collect and import, clean, then a transform–visualize–model loop, ending in communicate" loading="lazy" src="{{ site.url }}{{ site.baseurl }}/courses/tue_2IAB0-structure.jpg" class="img-responsive"/>
